...
exploration of git ![tree of life](git.png){#git}
...
fusion_data<-tar_read("fusion_data")
```
...
trajectoires <- fusion_data |> 
  dplyr::group_by(tag_id) |>
    dplyr::arrange(datetime, .by_group = TRUE) |>  # tri par datetime dans chaque groupe
    dplyr::summarise(
      n_points = dplyr::n(),
...
knitr::kable(trajectoires, caption = "Caractéristiques des trajectoires")
```

### La carto qui ne s'exportait pas en HTML

![Figure 1: GPS data for all individuals](Capture%20d'écran%202025-12-05%20105745.png){#fig-gpsdata}

### D'autres analyses...

![Figure 2: longitude des individus en fonction du temps](figures/Figure_longitude_time.png){#longitude}

![Figure 3: latitude des individus en fonction du temps](figures/Figure_latitude_time.png){#latitude}

![Figure 4: vitesse des individus en fonction du temps](figures/Figure_speed.png){#speed}